...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            epoch_sec = time.time() - epoch_time
            print("Epoch: {} cost time: {}".format(epoch + 1, epoch_sec))
            ...
            history_path = os.path.join(os.path.dirname(self.args.checkpoints), 'metrics_history.csv')
    ...
    def test(self, setting, test=0):
        ...
        common_metrics = compute_metrics(trues, preds)
        mae = common_metrics['mae']
        mse = common_metrics['mse']
        rmse = common_metrics['rmse']
        r2 = common_metrics['r2']
